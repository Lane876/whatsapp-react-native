...
function RootNavigator() {
  return (
    ...
    headerTitleStyle:{
      ...
      <Stack.Screen name="ChatRoom" component={ChatRoomScreen} options={({route})=> ({ title: route.params.name, headerRight: ()=> (
        <View style={{flexDirection:"row", width:100, justifyContent:"space-between", marginRight:10, alignItems:"center"}}>
